...
## 📌 Goal
Researching user behavior for the application of a start-up company selling food products.

---

## 📄 Description

The project focused on analyzing a dataset of a start-up company selling food products. The project involved loading the data, cleaning and preprocessing it, performing exploratory data analysis (EDA) and hypothesis testing
